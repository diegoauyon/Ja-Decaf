...
public class Main implements GPMessageConstants
{
    ...
    private LinkedList<org.jdom.Content> elementosMetodos = new LinkedList<org.jdom.Content>();
        ...
        try{
            if(this.error == false){
               ...
               // elementos.add(papa);
                ...
                Element metodos = new Element("methods");
    			for (org.jdom.Content element: elementosMetodos)
    			{
