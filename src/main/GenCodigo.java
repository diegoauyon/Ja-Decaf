...
public class GenCodigo {
  ...
  //  private LinkedList<String> locacionTemporales = new LinkedList<String>();
    ...
    Element op,elePlano,cond,salto,retorno,asignacion,llamada,param;
   ...
   public void generar(){
        ...
        elePlano = new Element("Funcion");
        elePlano.setAttribute("nombre", nombre.replace('|', '_'));
       // Element plano = new Element("Plano");
        ...
        this.agregarACodigo(new Comentario("*******************************************"));
        this.agregarACodigo(new Plano(nombre+" proc far"));
       ...
       // elePlano.addContent(plano);
        ...
        for(int i = 1; i < this.numTemp; i++){
            ...
            elePlano.addContent(new Comment(("t|_"+i)+" = "+"stack["+(i*tamnioIndice-tamnioIndice+this.inicio_dir_temp)+"]"));
        }
    ...
    public String generarExpresion(Reduction reduccion){
        ...
        switch(reduccion.getParentRule().getTableIndex())
        {
            ...
            case Main.RuleConstants.RULE_VALUE2:
                //<Value> ::= <metodoCall>
                retorno = this.generarLlamada((Reduction)reduccion.getToken(0).getData());
                break;
    ...
    public String generarLlamada(Reduction reduccion){
        ...
        switch(reduccion.getParentRule().getTableIndex()){
            case Main.RuleConstants.RULE_METHODCALL_ID_LPARAN_RPARAN:
                ...
                if(  llamado.darRet().darNombreTipo().equals("void") ){
                    ...
                    -------------------------------------------------------------------------*/
                    this.generarLlamada((Reduction)reduccion.getToken(2).getData());
            ...
            case Main.RuleConstants.RULE_OPT_ARG_SEPARATED:
                ...
                this.generarLlamada((Reduction)reduccion.getToken(0).getData());
                break;
            ...
            case Main.RuleConstants.RULE_ARG:
                //<arg> ::= <expression>
                t1 = this.generarExpresion((Reduction)reduccion.getToken(0).getData());
                this.agregarACodigo(new Parametro(t1));
